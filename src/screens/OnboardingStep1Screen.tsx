...
const validateYear = (value: string) => {
  ...
  if (isNaN(num) || num < 2000 || num > CURRENT_YEAR + 1) return `Ano entre 2000 y ${CURRENT_YEAR + 1}`;
  return undefined;
};
...
export const OnboardingStep1Screen: React.FC = () => {
  ...
  const handleContinue = async () => {
    if (!isFormValid(firstName, lastName, vehiclePlate, vehicleBrand, vehicleModel, vehicleColor, vehicleYear, termsAccepted)) return;
    setLoading(true);
    setSubmitError('');
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Input
          placeholder="Nombre"
          value={firstName}
          onChangeText={(t) => { setFirstName(t); setError('firstName', undefined); }}
        ...
        <Input
          ...
          value={lastName}
          onChangeText={(t) => { setLastName(t); setError('lastName', undefined); }}
        ...
        <View style={styles.vehicleTypes}>
          {VEHICLE_TYPES.map((type) => (
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={[styles.vehicleTypeText, vehicleType === type && styles.vehicleTypeTextSelected]}>
                {type}
              </Text>
            </TouchableOpacity>
          ))}
        ...
        <Input
          placeholder="Patente"
          value={vehiclePlate}
          onChangeText={(t) => { setVehiclePlate(t.toUpperCase()); setError('vehiclePlate', undefined); }}
        ...
        <View style={styles.row}>
          <Input
            placeholder="Marca"
            value={vehicleBrand}
            onChangeText={(t) => { setVehicleBrand(t); setError('vehicleBrand', undefined); }}
          ...
          <Input
            placeholder="Modelo"
            value={vehicleModel}
            onChangeText={(t) => { setVehicleModel(t); setError('vehicleModel', undefined); }}
        ...
        <View style={styles.row}>
          <Input
            placeholder="Color"
            value={vehicleColor}
            onChangeText={(t) => { setVehicleColor(t); setError('vehicleColor', undefined); }}
          ...
          <Input
            placeholder="Año"
            value={vehicleYear}
            onChangeText={(t) => { setVehicleYear(t); setError('vehicleYear', undefined); }}
        ...
        <Button
          ...
          disabled={!isFormValid(firstName, lastName, vehiclePlate, vehicleBrand, vehicleModel, vehicleColor, vehicleYear, termsAccepted)}
          loading={loading}
          variant="cta"
          style={styles.button}
        />
