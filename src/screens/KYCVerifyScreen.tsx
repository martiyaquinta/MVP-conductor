    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Para garantizar la seguridad de todos, necesitamos verificar tu
          identidad con nuestro sistema DIDIT. Vas a necesitar tu DNI y acceso
          a la camara.
        </Text>
        <Button
