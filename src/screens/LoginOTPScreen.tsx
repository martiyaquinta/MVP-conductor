  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        {email ? `Te enviamos un codigo a ${displayEmail}` : 'Te enviamos un codigo de verificacion'}
      </Text>
      <OTPInput length={6} value={otp} onChange={setOtp} />
      <TouchableOpacity
        onPress={handleResend}
        disabled={cooldown > 0 || verifyEmail.isPending}
      >
        <Text
          style={[
            styles.resend,
            (cooldown > 0 || verifyEmail.isPending) && styles.resendDisabled,
          ]}
        >
          {cooldown > 0
